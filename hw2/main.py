...
from common import standard_deviation, split_by, median, find_outliers, get_percentile_exclusive, get_iqr, histogram, compute_z_score, cdf, confidence_interval_z, compute_required_sample_size, compute_standard_error
def problem_set_1():
    mean = 2.8
    std = 2
    sample = 4.8
...
def problem_set_8():
    ...
    n = len(hormone_df)
    start, end = confidence_interval_z(mean, n, std, .99)
